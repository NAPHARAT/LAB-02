...
4. บันทึกผล
   ...
   จากการทดลองใบงานที่2 เรื่องการเพิ่ม Message Map ลงในโปรแกรม Win32 API โดยการพิมพ์ตามโค้ดในข้างต้น เมื่อรัดโปรแกรมแล้วจะมีหน้าต่างขึ้น และมีรูปวงรีในนั้น
   ดังภาพ
![]()
